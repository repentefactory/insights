...
describe("metabase-smoketest > admin", () => {
  ...
  describe("Admin can setup an account", () => {
    it("should set up LibraFactory Insights", () => {
      // This is a simplified version of the "scenarios > setup" test
      cy.visit("/");
      cy.findByText("Welcome to LibraFactory Insights");
      ...
      cy.findByLabelText("Name").type("LibraFactory Insights H2");
      ...
      cy.findByLabelText(
        "Allow LibraFactory Insights to anonymously collect usage events",
      ).click();
      ...
      cy.findByText("Take me to LibraFactory Insights").click();
  ...
  describe("Admin has basic functionality", () => {
    ...
    it.skip("should add a simple summarized question as admin", () => {
      ...
      // Also, selecting LibraFactory Insights H2 doesn't do anything
