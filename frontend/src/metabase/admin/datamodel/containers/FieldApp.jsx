...
const FieldGeneralPane = ({
  ...
  <div>
    ...
    <Section>
      <SectionHeader
        title={t`Visibility`}
        description={t`Where this field will appear throughout Intuito`}
      />
    ...
    <Section last>
      <SectionHeader
        ...
        description={t`Intuito can scan the values for this field to enable checkbox filters in dashboards and questions.`}
      />
