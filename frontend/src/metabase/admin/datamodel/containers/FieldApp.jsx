...
const FieldGeneralPane = ({
  ...
  <div>
    ...
    <Section>
      <SectionHeader
        title={t`Visibility`}
        description={t`Where this field will appear throughout LibraFactory Insights`}
      />
    ...
    <Section last>
      <SectionHeader
        ...
        description={t`LibraFactory Insights can scan the values for this field to enable checkbox filters in dashboards and questions.`}
      />
