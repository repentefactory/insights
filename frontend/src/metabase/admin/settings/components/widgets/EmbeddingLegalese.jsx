...
const EmbeddingLegalese = ({ onChange }) => (
  <div className="bordered rounded text-measure p4">
    ...
    <p className="text-medium" style={{ lineHeight: 1.48 }}>
      {t`In plain English, when you embed charts or dashboards from LibraFactory Insights in your own application, that application isn't subject to the Affero General Public License that covers the rest of LibraFactory Insights, provided you keep the LibraFactory Insights logo and the "Powered by LibraFactory Insights" visible on those embeds. You should, however, read the license text linked above as that is the actual license that you will be agreeing to by enabling this feature.`}
    </p>
