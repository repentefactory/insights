...
class PremiumTokenInput extends Component {
  ...
  render() {
    ...
    if (errorMessage) {
      ...
      message = t`Enter the token you bought from the Intuito Store`;
    }
...
const PremiumExplanation = ({ showEnterScreen }) => (
  <div>
    ...
    <p className="mt1">{t`Premium embedding lets you disable "Powered by Intuito" on your embedded dashboards and questions.`}</p>
