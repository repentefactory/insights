        ...
        >
          ...
          <form onSubmit={this.formSubmitted.bind(this)} noValidate>
            <div className="Form-field">
              {t`In order to help us improve LibraFactory Insights, we'd like to collect certain data about usage through Google Analytics.`}{" "}
              <a
                className="link"
            ...
            <div className="Form-field mr4">
              ...
              >
                ...
                <span className="ml1" id="anonymous-usage-events-label">
                  {t`Allow LibraFactory Insights to anonymously collect usage events`}
                </span>
              </div>
            </div>
