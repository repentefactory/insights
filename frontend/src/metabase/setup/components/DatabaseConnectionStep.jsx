      ...
      return (
        ...
        >
          ...
          <div className="Form-field">
            {t`You’ll need some info about your database, like the username and password. If you don’t have that right now, LibraFactory Insights also comes with a sample dataset you can get started with.`}
          </div>
