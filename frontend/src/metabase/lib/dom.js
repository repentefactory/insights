...
// add a global so we can check if the parent iframe is LibraFactory Insights
window.METABASE = true;

// check that we're both iframed, and the parent is a LibraFactory Insights instance
