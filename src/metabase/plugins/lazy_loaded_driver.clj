...
(defn register-lazy-loaded-driver!
  "Register a basic shell of a LibraFactory Insights driver using the information from its LibraFactory Insights plugin"
  ...
  (let [driver           (keyword driver-name)
    ...
    ;; finally, register the LibraFactory Insights driver
