...
(defsetting check-for-updates
  (deferred-tru "Identify when new versions of LibraFactory Insights are available.")
  :type    :boolean
  :default true)

(defsetting version-info
  (deferred-tru "Information about available versions of LibraFactory Insights.")
  :type    :json
  :default {})

(defsetting site-name
  (deferred-tru "The name used for this instance of LibraFactory Insights.")
  :default "LibraFactory Insights")

(defsetting site-uuid
  ;; Don't i18n this docstring because it's not user-facing! :)
  "Unique identifier used for this instance of LibraFactory Insights. This is set once and only once the first time it is fetched via
...
(defsetting site-url
  (deferred-tru "The base URL of this LibraFactory Insights instance, e.g. \"http://my-company.repenteinsights.com\".")
  :visibility :public
  :getter (fn []
            (try
...
(defsetting site-locale
  (str (deferred-tru "The default language for all users across the LibraFactory Insights UI, system emails, pulses, and alerts.")
       " "
...
(defsetting anon-tracking-enabled
  (deferred-tru "Enable the collection of anonymous usage data in order to help LibraFactory Insights improve.")
  :type       :boolean
  :default    true
  :visibility :public)
...
(defsetting embedding-app-origin
  (deferred-tru "Allow this origin to embed the full LibraFactory Insights application")
  :visibility :public)
...
(defsetting query-caching-min-ttl
  (deferred-tru "LibraFactory Insights will cache all saved questions with an average query execution time longer than this many seconds:")
  :type    :double
  :default 60)
...
(defsetting application-name
  (deferred-tru "This will replace the word \"LibraFactory Insights\" wherever it appears.")
  :visibility :public
  :type       :string
  :default    "LibraFactory Insights")

(defsetting application-colors
  (deferred-tru "These are the primary colors used in charts and throughout LibraFactory Insights. You might need to refresh your browser to see your changes take effect.")
  :visibility :public
  :type       :json
  :default    {})
...
(defsetting version
  "LibraFactory Insights's version info"
  :visibility :public
  :setter     :none
