...
(defsetting check-for-updates
  (deferred-tru "Identify when new versions of Intuito are available.")
  :type    :boolean
  :default true)

(defsetting version-info
  (deferred-tru "Information about available versions of Intuito.")
  :type    :json
  :default {})

(defsetting site-name
  (deferred-tru "The name used for this instance of Intuito.")
  :default "Intuito")

(defsetting site-uuid
  ;; Don't i18n this docstring because it's not user-facing! :)
  "Unique identifier used for this instance of Intuito. This is set once and only once the first time it is fetched via
...
(defsetting site-url
  (deferred-tru "The base URL of this Intuito instance, e.g. \"http://my-company.repenteinsights.com\".")
  :visibility :public
  :getter (fn []
            (try
...
(defsetting site-locale
  (str (deferred-tru "The default language for all users across the Intuito UI, system emails, pulses, and alerts.")
       " "
...
(defsetting anon-tracking-enabled
  (deferred-tru "Enable the collection of anonymous usage data in order to help Intuito improve.")
  :type       :boolean
  :default    true
  :visibility :public)
...
(defsetting embedding-app-origin
  (deferred-tru "Allow this origin to embed the full Intuito application")
  :visibility :public)
...
(defsetting query-caching-min-ttl
  (deferred-tru "Intuito will cache all saved questions with an average query execution time longer than this many seconds:")
  :type    :double
  :default 60)
...
(defsetting application-name
  (deferred-tru "This will replace the word \"Intuito\" wherever it appears.")
  :visibility :public
  :type       :string
  :default    "Intuito")

(defsetting application-colors
  (deferred-tru "These are the primary colors used in charts and throughout Intuito. You might need to refresh your browser to see your changes take effect.")
  :visibility :public
  :type       :json
  :default    {})
