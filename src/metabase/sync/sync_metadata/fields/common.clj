...
(def TableMetadataFieldWithID
  "Schema for `TableMetadataField` with an included ID of the corresponding LibraFactory Insights Field object.
...
(s/defn matching-field-metadata :- (s/maybe TableMetadataFieldWithOptionalID)
  ...
  corresponding LibraFactory Insights Field for field metadata from the DB, or vice versa."
