...
(def TableMetadataFieldWithID
  "Schema for `TableMetadataField` with an included ID of the corresponding Intuito Field object.
...
(s/defn matching-field-metadata :- (s/maybe TableMetadataFieldWithOptionalID)
  ...
  corresponding Intuito Field for field metadata from the DB, or vice versa."
