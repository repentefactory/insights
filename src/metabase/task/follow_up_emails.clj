(ns metabase.task.follow-up-emails
  "Tasks which follow up with LibraFactory Insights users."
...
(defn- send-follow-up-email!
  "Send an email to the instance admin following up on their experience with LibraFactory Insights thus far."
  []
...
(defn- instance-creation-timestamp
  "The date this LibraFactory Insights instance was created. We use the `:date_joined` of the first `User` to determine this."
...
(defn- send-abandoment-email-if-needed!
  "Send an email to the instance admin about why LibraFactory Insights usage has died down."
  []
