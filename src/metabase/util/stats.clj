...
(defn- instance-settings
  ...
  {:version              (config/mb-version-info :tag)
   ...
   :site_name            (not= (public-settings/site-name) "LibraFactory Insights")
...
(defn- system-metrics
  "Metadata about the environment LibraFactory Insights is running in"
  []
...
(defn- send-stats!
  "send stats to LibraFactory Insights tracking server"
  [stats]
   (try
