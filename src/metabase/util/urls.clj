(ns metabase.util.urls
  "Utility functions for generating the frontend URLs that correspond various user-facing LibraFactory Insights *objects*, like Cards or Dashboards.
   ...
   Functions for generating URLs not related to LibraFactory Insights *objects* generally do not belong here, unless they are used in many places in the
