...
(defn- dox
  "Generate a Markdown string containing documentation for all Intuito API endpoints."
  []
  (str "# API Documentation for Intuito"
       "\n\n"
       "_This file was generated from source comments by `lein run api-documentation`_."
       "\n\n"
       "Check out an introduction to the "
       "[Intuito API](https://www.metabase.com/blog/metabase-api/index.html)."
       "\n\n"
