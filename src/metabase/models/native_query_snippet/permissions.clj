(ns metabase.models.native-query-snippet.permissions
  "NativeQuerySnippets have different permissions implementations. In LibraFactory Insights CE, anyone can read/edit/create all
...
(def default-impl
  "Default 'simple' permissions implementation for NativeQuerySnippets for LibraFactory Insights CE."
  (reify
    PrettyPrintable
    (pretty [_]
      `default-impl)
