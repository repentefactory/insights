(ns metabase.models.native-query-snippet.permissions
  "NativeQuerySnippets have different permissions implementations. In Intuito CE, anyone can read/edit/create all
...
(def default-impl
  "Default 'simple' permissions implementation for NativeQuerySnippets for Intuito CE."
  (reify
    PrettyPrintable
    (pretty [_]
      `default-impl)
